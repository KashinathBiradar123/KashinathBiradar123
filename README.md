...
Data Scientist · Machine Learning Engineer · Building things that learn.

---

## What I Do

I turn raw, messy data into models that make decisions.  
My work spans the full pipeline — data wrangling, feature engineering, model training, and deployment.

**Core Stack**
- Languages: Python
- ML: Scikit-learn, XGBoost, TensorFlow/Keras
- Data: Pandas, NumPy, SQL
- Tools: Jupyter, Git, Matplotlib, Seaborn
...
- Deepening expertise in ML systems end-to-end
- Open to collaborations on real-world ML problems
